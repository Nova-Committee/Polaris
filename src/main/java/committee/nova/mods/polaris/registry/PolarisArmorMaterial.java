...
public enum PolarisArmorMaterial implements ArmorMaterial {
    ...
    SupremeGenesis("supreme_genesis", 5, new int[]{7, 10, 10, 7}, 15,
            SoundEvents.ARMOR_EQUIP_NETHERITE, 6.0F, 0.225F, new float[]{4, 4, 4, 4}, () -> Ingredient.of(PolarisItems.SpiritOfDivinity.get())),
    SupremeGenesisWhite("supreme_genesis_white", 6, new int[]{8, 11, 11, 8}, 15,
            SoundEvents.ARMOR_EQUIP_NETHERITE, 7.0F, 0.25F, new float[]{4, 4, 4, 4}, () -> Ingredient.of(PolarisItems.SpiritOfDivinity.get())),
